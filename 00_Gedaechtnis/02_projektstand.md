...
Aktive Tests: `npm test` (15 Logik-/Strukturtests, 36 Browserfälle bestanden), `npm run qa:lighthouse` (24.09.2026, 14:30 bis 14:31 Uhr MESZ: Performance 96 bis 99, übrige Kategorien jeweils 100). Historische QA-Werkzeuge und überholte Anleitungen sind archiviert; README/CLAUDE beschreiben den aktuellen Stack. Push und Merge im fortgeführten Auftrag autorisiert und erledigt. Die zusätzliche Live-Prüfung umfasst neue Texte, Assets, Menü, Cloudflare, echte Karte, Routen-Zielaufruf und Feiertagsstatus bei fremder Gerätezeitzone. Google-Einwilligungsseite vor der Route ist ausdrücklich dokumentiert; keine echten Anrufe oder E-Mails ausgeführt.
