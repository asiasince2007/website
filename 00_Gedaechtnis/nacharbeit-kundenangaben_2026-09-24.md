...
3. Jüngste Nacharbeit: [PR #51](https://github.com/asiasince2007/website/pull/51), Merge `e37f8a44ef3ed00d291dc70322fc1358eab19c3e` am 24.09.2026 um 14:33 Uhr MESZ; [Pages-Lauf 35999848486](https://github.com/asiasince2007/website/actions/runs/35999848486) erfolgreich. Erneute Live-Prüfung ab 14:34 Uhr MESZ **bestanden**, Exit 0: sechs Seiten HTTP 200 mit neuer Version `2026092402`, CSS/JS stimmen mit lokalem Stand überein, Feiertagszeile und neuer Schließungshinweis vorhanden, keine Halb-/Geviertstriche im Seitentext, keine Gruppenbuttons, beide Bewertungszahlen aktuell. Mobilmenü mit Tastatur/Fokus/weißem Anruftext, Datenschutz bei 320 px, E-Mail mit JavaScript entschlüsselt und ohne JavaScript weiterhin geschützt. Reale Karte erst nach Freigabe, HTTP 200, korrekter Marker/Adresse und 4,4/128 zusätzlich visuell im Screenshot bestätigt, Ausblenden funktioniert. Reales Routenziel ohne JavaScript korrekt; Googles externe Einwilligungsseite bleibt eine Prüfgrenze. Mit Gerätezeitzone Tokio und simulierter Zeit am 03.10.2026 lautet der Live-Status: „Heute geschlossen (Tag der Deutschen Einheit), öffnet Montag um 9 Uhr“. Keine Browser-JavaScript-Fehler. Sitemap liefert sechs URLs mit Datum 24.09.2026, interne Test-/Gedächtnis-/Archivpfade erneut 404. Neuer Bericht `docs/qa-output/live-pruefung.json`; erster erfolgreicher Nachweis separat als `live-pruefung-pr50.json` aufbewahrt.

Der anschließende Abschlusscommit ergänzt ausschließlich Projektgedächtnis und Prüfnachweis. Die geprüften Website-Dateien bleiben auf dem oben genannten Codezustand.
